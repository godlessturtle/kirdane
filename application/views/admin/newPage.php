...
<head>
  ...
  <title>Yeni Sayfa Oluştur - Yönetim | Kirdane.Com</title>
          ...
          <form action="<?php echo base_url('panel/create/page'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group col-md-5">
                ...
                <input type="text" name="page_slogan" placeholder="Başlığın altında görünür, zorunlu değil" class="form-control">
              </div>
