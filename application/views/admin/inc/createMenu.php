...
<head>
    ...
    <title>Menü Oluştur - Yönetim | Kirdane.Com</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url('panel/menu/submit'); ?>" method="POST"
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="menu_baslik" required="required" class="form-control" id="inputEmail3"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" max="36" min="0" required="required" name="menu_sira" class="form-control"
                                               id="inputEmail3" placeholder="0,1,2,3....">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Menü Türü</label>
                                        <select id="selBox" required="required" name="menuTuru" class="form-control select2 mega" style="width: 100%;">
                                            <option selected="selected">Menü Türü</option>
                                            <option>Sayfa Yönlendirme</option>
                                            <option>Link Yönlendirme</option>
                                            <option>Mega Menü</option>
                                ...
                                <div id="megaMenu" style="display:none;" class="col-md-6 form-group kategori">
                                    <label>Kategoriler</label>
                                    <select name="kategoriler" class="form-control select2" style="width: 100%;">
                                        <option class="selected"></option>
                                        <?php foreach($categories as $cat){ ?>
                                            <option id="<?php echo $cat->cat_id; ?>">
